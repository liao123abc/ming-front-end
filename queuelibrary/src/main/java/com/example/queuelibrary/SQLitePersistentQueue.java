...
import com.example.queuelibrary.db.SQLiteQueueDbHelper;
import com.example.queuelibrary.db.SQLiteQueueTableManager;
...
public class SQLitePersistentQueue<E> implements Queue<E>, Closeable {
    ...
    public boolean add(E e) {
        long rowId = -1;
        try {
            rowId = mDbManager.insert(mConverter.serialize(e));
