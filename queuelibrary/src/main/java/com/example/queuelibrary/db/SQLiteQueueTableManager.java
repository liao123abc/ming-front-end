package com.example.queuelibrary.db;
...
import com.example.queuelibrary.db.sqlite_queue_contract.SQLiteQueueTable;
...
//    }
    ...
    public void queryAll() {
        String sql = "SELECT * FROM " + SQLiteQueueTable.TABLE_NAME;
        Cursor cursor = mDb.rawQuery(sql, null);

        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    String value = cursor.getString(cursor.getColumnIndex(SQLiteQueueTable.COLUMN_NAME_VALUE));
                    Log.d("queue", " " + value);
